...
def eval_model(args):
    ...
    image_processor = CLIPImageProcessor.from_pretrained("/data/tanfl/cache/vit-large-patch14/", torch_dtype=torch.float16)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-name", type=str, default="/data/tanfl/cache/vary_toy")
