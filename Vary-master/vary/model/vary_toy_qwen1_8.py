...
class varyQwenModel(QWenModel):
    ...
    def __init__(self, config: QWenConfig):
        ...
        self.vision_tower = CLIPVisionModel.from_pretrained('/data/tanfl/cache/vit-large-patch14/vit-large-patch14/')
    ...
    def initialize_vision_modules(
        ...
        # 224*224
        image_processor = CLIPImageProcessor.from_pretrained('/data/tanfl/cache/vit-large-patch14/vit-large-patch14/')
        # 1024*1024
